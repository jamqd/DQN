...
def main():
    ...
    parser.add_argument('--use_ddqn', dest='use_ddqn', action='store_true', help = "use ddqn instead of dqn", type=bool)
    ...
    parser.add_argument('--render', dest='render', action='store_true', help = "render environment or not", type=bool)
    ...
    parser.add_argument('--offline', dest='online', action='store_false', help = "online vs offline training", type=bool)
